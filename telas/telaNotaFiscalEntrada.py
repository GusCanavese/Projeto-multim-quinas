...
def telaNotaFiscalEntrada(self, dadosNota):
    ...
    criaBotao(self.frameTelaNotaFiscalEntrada, "Próximo - Tela de Produtos", 0.25, 0.94, 0.15, lambda: telaProdutos(self, dadosNota, 0, variavelCFOP.get())).place(anchor="nw")
