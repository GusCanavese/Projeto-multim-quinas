...
def telaVerProduto(self, p):
    ...
    criaLabelDescritivo(frame, "Nome do produto",             0.05, 0.07, 0.35, "#38343c", ctk.StringVar(value=p[1]))
    ...
    criaLabelDescritivo(frame, "CNPJ",                        0.79, 0.07, 0.15, "#38343c", ctk.StringVar(value=p[4]))



    criaLabelDescritivo(frame, "NCM",            0.05, 0.25, 0.15, "#38343c", ctk.StringVar(value=p[5]))
    criaLabelDescritivo(frame, "CFOP",           0.25, 0.25, 0.15, "#38343c", ctk.StringVar(value=p[6]))
    criaLabelDescritivo(frame, "CEST",           0.43, 0.25, 0.15, "#38343c", ctk.StringVar(value=p[7]))
    
    criaLabelDescritivo(frame, "Origem CST",     0.61, 0.25, 0.15, "#38343c", ctk.StringVar(value=p[8]))
    criaLabelDescritivo(frame, "Código interno", 0.79, 0.25, 0.15, "#38343c", ctk.StringVar(value=p[2]))
