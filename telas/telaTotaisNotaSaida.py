...
def telaTotaisNotaSaida(self, EhNotaDoConsumidor):
    ...
    criaBotao(self.frameTelaTotais, "Próximo - Tela de faturamento", 0.25, 0.94, 0.15, lambda: telaGerarFaturamentoEntradaNota(self, None, totalNota.set(0), EhNotaDoConsumidor)).place(anchor="nw")
